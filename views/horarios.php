...
<body id="page-top">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <br>
                <!-- Botón para mostrar el modal de agregar un nuevo horario -->
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#horario">
                    <span class="glyphicon glyphicon-plus"></span> Agregar horario <i class="fa fa-sticky-note" aria-hidden="true"></i>
                </button>
            </div>
    ...
    <?php include "../includes/form_horario.php"; // Incluir el formulario para agregar horarios ?>
